...
public class PasswordEditText extends EditText {
    ...
    public PasswordEditText(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            borderRadius = a.getDimension(
                    R.styleable.PasswordInputView_borderRadis,
                    defaultBorderRadius);
    ...
    protected void onDraw(Canvas canvas) {
        float width = getResources().getDimension(R.dimen.password_width) * 6;
        float height = getResources().getDimension(R.dimen.password_height);
