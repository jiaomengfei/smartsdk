...
//    private static final float scale = App.getsInstance().getResources().getDisplayMetrics().density;
//
//    private static final float scaledDensity = App.getsInstance().getResources().getDisplayMetrics().scaledDensity;
