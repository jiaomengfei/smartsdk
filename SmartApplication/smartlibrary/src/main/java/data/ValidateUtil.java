...
public class ValidateUtil {
    ...
    public static boolean isMobile(String str) {
        ...
        String reg1 = "[^0-9]";
        String mobileStr = str.replaceAll(reg1, "");
        if (mobileStr.length() == 11) {
            String mobilePreStr = mobileStr.substring(0, 3);
            if (MOBILE_PREFIX_STR.contains(mobilePreStr)) {
                return true;
            }
        }
        return false;
    ...
    public static String parseMobile(String mobile) {
        if (isMobile(mobile)) {
            ...
            String reg1 = "[^0-9]";
            String mobileStr = mobile.replaceAll(reg1, "");
            return mobileStr;
        }
        return null;
    }
     ...
     * @return
     */
    public static String mobileJ(String mobile) {
        String mobileJ = "";
        if (isMobile(mobile)) {
            mobileJ += mobile.substring(0, 3);
            mobileJ += "****";
            mobileJ += mobile.substring(7, mobile.length());
        }
        return mobileJ;
    }
     ...
     * @return
     */
    public static boolean isValidateId(String idCard) {
        String id = idCard.toLowerCase();
